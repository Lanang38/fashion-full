<?php
require_once "php_edit_category.php";
?>
...
<head>
    <title>Dressclo - Edit Categories</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="description" content="Category management page for Dressclo" />
    <meta name="keywords" content="admin templates, bootstrap admin templates, categories, product management" />
                                            ...
                                            <div class="card-body">
                                                <form method="post" action="edit_category.php" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <img src="<?php echo $category['image']; ?>" alt="Current Image" style="max-width: 100px; margin-top: 10px;">
