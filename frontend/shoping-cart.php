                ...
                <tbody>
                  <tr>
                    <td class="shoping__cart__item">
                      <img src="img/cart/Jeans.jpg" alt="" />
                      <h5>Black Skinny Jeans</h5>
                    </td>
                    <td class="shoping__cart__price">Rp.300,000</td>
                    ...
                    <td class="shoping__cart__total">Rp.300,000</td>
                  ...
                  <tr>
                    <td class="shoping__cart__item">
                      <img src="img/cart/jaket.jpg" alt="" />
                      <h5>Screamous Jacket Quilted Liner</h5>
                    </td>
                    <td class="shoping__cart__price">Rp.445,000</td>
                    <td class="shoping__cart__quantity">
                      <div class="quantity">
                        <div class="pro-qty">
                    ...
                    <td class="shoping__cart__total">Rp.890,000</td>
                    <td class="shoping__cart__item__close">
                      <span class="icon_close"></span>
                    </td>
                  </tr>
                  <tr>
                    <td class="shoping__cart__item">
                      <img src="img/cart/Jordan11.jpg" alt="" />
                      <h5>Jordan 11</h5>
                    </td>
                    <td class="shoping__cart__price">Rp.1,850,000</td>
                    <td class="shoping__cart__quantity">
                      <div class="quantity">
                        <div class="pro-qty">
                          <input type="text" value="1" />
                    ...
                    <td class="shoping__cart__total">Rp.1,850,000</td>
                    <td class="shoping__cart__item__close">
                      <span class="icon_close"></span>
                    </td>
                  </tr>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="shoping__checkout">
              <h5>Cart Total</h5>
              <ul>
                <li>Subtotal <span>Rp.3,040,000</span></li>
                <li>Total <span>Rp.3,040,000</span></li>
              </ul>
